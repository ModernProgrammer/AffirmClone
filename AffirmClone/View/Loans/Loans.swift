...
class LoanCollectionViewCell: UICollectionViewCell, UICollectionViewDataSource, UICollectionViewDelegate {
    let cellId = "cellId"
...
extension CurrentLoansView {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.backgroundColor = indexPath.item % 2 == 0 ? .green : .yellow
        return cell
    }
}
